...
- The active-focus completion ratio uses only tasks assigned to that focus.
...
- Starting a new focus is reversible in data terms because the previous focus and tasks remain in history; switching an archived focus back to active is a later interaction.
