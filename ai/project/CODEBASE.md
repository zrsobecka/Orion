...
Orion is one Tauri package: React owns the interface, Rust owns desktop access and persistence, SQLite stores project intent, and local Git supplies repository facts.
...
See [ARCHITECTURE.md](ARCHITECTURE.md) for data ownership, flow, and extension boundaries.
